            ...
            <div className="hidden md:flex space-x-6 lg:space-x-8 items-center">
              {MCC_NAV_LINKS.map((link) => (
                <button
                  ...
                  className={`text-[10px] font-bold uppercase tracking-[0.2em] transition-all hover:text-mccGold relative group whitespace-nowrap ${
                    activePage === link.id ? 'text-mccGold' : ''
                  }`}
                >
                  {link.name}
